...
const CACHE_NAME = "truerate-cache-v5"
const STATIC_CACHE = "truerate-static-v3"
const API_CACHE = "truerate-api-v3"
...
// Static assets that rarely change (do NOT include /_next/ — hashed chunks change every build;
// cache-first on _next causes ChunkLoadError and broken URLs after deploy or dev/prod switches)
const STATIC_ASSETS = ["/fonts/", "/images/"]
...
self.addEventListener("fetch", (event) => {
  ...
  // Always hit the network for Next.js build output — never cache-first (avoids stale chunks,
  // wrong manifests, and odd failures like /_next//_next/... after updates).
