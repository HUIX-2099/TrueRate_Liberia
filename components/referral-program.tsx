      ...
      <CardContent className="space-y-6 pt-6">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          <div className="space-y-2">
            <div className="h-10 w-10 rounded-full bg-muted/40 border border-border/40 flex items-center justify-center mx-auto">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">Friend joins</p>
          </div>
          <div className="space-y-2">
            <div className="h-10 w-10 rounded-full bg-muted/40 border border-border/40 flex items-center justify-center mx-auto">
        ...
        {!user && (
          <div className="text-center py-4 bg-muted/50 rounded-lg">
            <p className="text-sm text-muted-foreground mb-2">
              Sign in to track referrals and rewards
            </p>
