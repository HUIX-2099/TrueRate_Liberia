  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        {/* Best Rate Highlight */}
        <div className="p-4 bg-muted/40 border border-border/40 border-secondary/30 rounded-lg mb-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="text-right">
                    ...
                    <div className={`text-xs flex items-center justify-end gap-1 ${ rateChange > 0 ? 'text-destructive' : rateChange < 0 ? 'text-secondary' : 'text-muted-foreground' }`}>
                      {rateChange > 0 ? <TrendingUp className="h-3 w-3 text-green-600 dark:text-green-400" /> : 
                       rateChange < 0 ? <TrendingDown className="h-3 w-3 text-red-600 dark:text-red-400" /> : null}
