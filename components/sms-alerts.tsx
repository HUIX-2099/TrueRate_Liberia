...
export function SMSAlerts() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "SMS alerts are on",
        description: `You'll receive updates at ${phoneNumber}`,
      })
      setPhoneNumber("")
    } catch {
      toast({
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" className="w-full" disabled={isSubmitting}>
              {isSubmitting ? "Activating..." : "Turn on SMS alerts"}
            </Button>
          </form>
        </CardContent>
      </Card>
        ...
        <Card className="bg-secondary/10 border-secondary/20">
          <CardContent className="pt-6">
            <div className="flex gap-3">
              <Smartphone className="h-5 w-5 flex-shrink-0 mt-1 text-primary" />
              <div className="space-y-2">
          ...
          <CardContent>
            <div className="rounded-lg bg-muted p-4 space-y-3">
              <div className="flex items-start gap-3">
                <MessageSquare className="h-4 w-4 flex-shrink-0 mt-1 text-blue-600 dark:text-blue-400" />
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="space-y-4">
              <div className="flex gap-3">
                <CheckCircle className="h-5 w-5 flex-shrink-0 mt-0.5 text-green-600 dark:text-green-400" />
                <div>
