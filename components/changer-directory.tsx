    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
        {filteredChangers.map((changer) => (
          <Card
            key={changer.id}
            className={`hover:shadow-lg transition-all cursor-pointer ${ selectedChanger === changer.id ? "ring-2 ring-primary" : "" }`}
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    ...
                    {changer.verified && <CheckCircle className="h-4 w-4 flex-shrink-0 text-green-600 dark:text-green-400" />}
                  </div>
                ...
                <div className="flex flex-col items-end gap-1 flex-shrink-0">
                  <div className="flex items-center gap-1">
                    <Star className="h-4 w-4 fill-secondary text-amber-600 dark:text-amber-400" />
