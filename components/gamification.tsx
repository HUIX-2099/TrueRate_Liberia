...
export function GamificationProfile() {
  ...
  const ranks = [
    { name: 'Newcomer', minPoints: 0, icon: <Users className="h-4 w-4 text-primary" /> },
    { name: 'Rate Reporter', minPoints: 50, icon: <Eye className="h-4 w-4 text-primary" /> },
    { name: 'Rate Guru', minPoints: 200, icon: <TrendingUp className="h-4 w-4 text-green-600 dark:text-green-400" /> },
    { name: 'Market Expert', minPoints: 500, icon: <Zap className="h-4 w-4 text-primary" /> },
    { name: 'TrueRate Champion', minPoints: 1000, icon: <Crown className="h-4 w-4 text-amber-600 dark:text-amber-400" /> },
  ]
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {earnedBadges.map(badge => (
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  <div className="h-10 w-10 rounded-full bg-muted/40 border border-border/40 flex items-center justify-center">
                    {badge.icon}
                  </div>
                  <div>
