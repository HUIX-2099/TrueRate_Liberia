...
export function ScrollToTop() {
  ...
  return (
    <Button
      ...
      className="fixed right-4 z-30 h-10 w-10 rounded-full border-border/80 bg-background/95 shadow-md backdrop-blur-sm md:bottom-8 md:right-6 md:h-11 md:w-11 bottom-[4.5rem]"
    >
