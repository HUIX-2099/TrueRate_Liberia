...
export function TradingChart({ data, predictions, currentRate }: TradingChartProps) {
  ...
  // Animation effect
  useEffect(() => {
    queueMicrotask(() => setAnimationProgress(0))
    ...
    <Card className="overflow-hidden">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Badge
                ...
                className={change >= 0 ? "bg-muted/40 border border-border/40 text-red-500" : "bg-muted/40 border border-border/40 text-green-500"}
              >
                {change >= 0 ? <TrendingUp className="h-3 w-3 mr-1 text-green-600 dark:text-green-400" /> : <TrendingDown className="h-3 w-3 mr-1 text-red-600 dark:text-red-400" />}
      ...
      <CardContent className="p-0 pb-4">
        <div className="relative">
          ...
          {/* Hover info tooltip */}
          {hoveredCandle && (
            <div className="absolute top-4 left-4 bg-card/95 border rounded-lg p-3 shadow-lg text-sm">
