...
export function SentimentAnalysis() {
  ...
  const getSentimentIcon = (sentiment: string) => {
    switch (sentiment) {
      ...
      case 'negative': return <ThumbsDown className="h-4 w-4 text-primary" />
  ...
  const getSeverityColor = (severity: string) => {
    switch (severity) {
      case 'high': return 'bg-muted/40 border border-border/40 text-destructive border-destructive/30'
      case 'medium': return 'bg-muted/40 border border-border/40 text-accent border-accent/30'
      default: return 'bg-muted/40 border border-border/40 text-secondary border-secondary/30'
    }
  }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Combined analysis of community, social media, and news sentiment
        </CardDescription>
      </CardHeader>
