  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 pb-20 md:pb-0">
        {/* Hero header */}
        <section className="relative border-b border-border bg-gradient-to-b from-primary/5 to-transparent dark:from-primary/10 dark:to-background">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-muted-foreground mt-1.5 text-sm md:text-base max-w-xl">
                  Commodity prices, import trends, risk indicators, and cost of living for Liberia.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4 py-8 space-y-10 max-w-6xl">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <Card className="overflow-hidden border border-border bg-card shadow-sm hover:shadow dark:shadow-none dark:border-muted-foreground/20 transition-shadow">
          ...
          <section>
            ...
            <div className="space-y-6">
              <Card className="border border-border bg-card shadow-sm dark:shadow-none dark:border-muted-foreground/20 overflow-hidden">
