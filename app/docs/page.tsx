    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pb-20 md:pb-0 overflow-x-hidden">
        <PageHero
          ...
          title="Built on verified market and official data"
          description="TrueRate combines rates, prices, and market signals from verified sources so money decisions are based on clear, transparent information."
          variant="centered"
          badges={
            <>
              <Badge>Data Sources & Methodology</Badge>
              <Badge className="bg-muted/40 border border-border/40 text-primary">100+ Sources</Badge>
            </>
          }
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8 space-y-3">
                <div className="flex flex-wrap items-center justify-center gap-2 mb-2">
                  ...
                  <Badge className="bg-muted/40 border border-border/40 text-primary">CBL & market</Badge>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Card className="border-border/40 rounded-2xl border-secondary/20 shadow-sm">
                  <CardHeader>
                    <div className="flex items-center gap-2">
                      <div className="h-10 w-10 rounded-lg bg-muted/40 border border-border/40 flex items-center justify-center">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-8 space-y-3">
                <div className="flex flex-wrap items-center justify-center gap-2 mb-2">
                  ...
                  <Badge className="bg-muted/40 border border-border/40 text-primary">Verified & Trusted</Badge>
                </div>
                <h2 className="text-3xl font-bold text-balance text-foreground">
                  Our Data Sources
                </h2>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                <Card className="border-border/40 rounded-2xl border-primary/20 shadow-sm hover:shadow-md transition-all">
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-sm">
                      ...
                      <li className="flex items-center gap-2">
                        <CheckCircle2 className="h-4 w-4 text-green-600 dark:text-green-400" />+ 26 more APIs
                      </li>
                    </ul>
                  </CardContent>
                </Card>

                <Card className="border-border/40 rounded-2xl border-secondary/20 shadow-sm hover:shadow-md transition-all">
                  <CardHeader className="pb-4">
                    <div className="h-12 w-12 rounded-xl bg-muted/40 border border-border/40 flex items-center justify-center mb-3">
                ...
                <Card className="border-border/40 rounded-2xl border-amber-500/20 shadow-sm hover:shadow-md transition-all">
                  <CardHeader className="pb-4">
                    <div className="h-12 w-12 rounded-xl bg-muted/40 border border-border/40 flex items-center justify-center mb-3">
                ...
                <Card className="border-border/40 rounded-2xl border-green-500/20 shadow-sm hover:shadow-md transition-all">
                  <CardHeader className="pb-4">
                    <div className="h-12 w-12 rounded-xl bg-muted/40 border border-border/40 flex items-center justify-center mb-3">
                ...
                <Card className="border-border/40 rounded-2xl border-purple-500/20 shadow-sm hover:shadow-md transition-all">
                  <CardHeader className="pb-4">
                    <div className="h-12 w-12 rounded-xl bg-muted/40 border border-border/40 flex items-center justify-center mb-3">
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-sm">
                      ...
                      <li className="flex items-center gap-2">
                        <CheckCircle2 className="h-4 w-4 text-green-600 dark:text-green-400" />+ 16 more providers
                      </li>
                    </ul>
                  </CardContent>
                </Card>

                <Card className="border-border/40 rounded-2xl border-blue-500/20 shadow-sm hover:shadow-md transition-all">
                  <CardHeader className="pb-4">
                    <div className="h-12 w-12 rounded-xl bg-muted/40 border border-border/40 flex items-center justify-center mb-3">
                      <Building2 className="h-6 w-6 text-primary" />
                    </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8 space-y-3">
                <div className="flex flex-wrap items-center justify-center gap-2 mb-2">
                  ...
                  <Badge className="bg-muted/40 border border-border/40 text-primary">Transparent process</Badge>
                </div>
                <h2 className="text-3xl font-bold text-balance text-foreground">
                  Our Methodology
                </h2>
              ...
              <div className="space-y-6">
                ...
                <Card className="border-border/40 rounded-2xl shadow-sm">
                  ...
                  <CardContent className="space-y-3">
                    <p className="text-muted-foreground">
                      Every data point goes through multi-layer verification to detect anomalies, fraud
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="flex flex-wrap items-center justify-center gap-2 mb-4">
                ...
                <Badge className="bg-muted/40 border border-border/40 text-primary">Open Methodology</Badge>
              </div>
              <h2 className="text-3xl font-bold mb-6 text-balance text-foreground">
                Our Commitment to Transparency
              </h2>
              <p className="text-base sm:text-lg text-muted-foreground mb-8 text-pretty max-w-3xl mx-auto">
                We believe Liberians deserve accurate, unbiased financial information—rates, prices, and tools. That&apos;s why we&apos;ve
                made our methodology transparent and our data sources verifiable.
              </p>
