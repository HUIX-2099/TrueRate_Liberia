    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="py-10 sm:py-14 md:py-16 flex-1 flex items-center justify-center px-4 text-center pb-20 md:pb-0 overflow-x-hidden">
        <div className="max-w-lg">
          ...
          <Card className="mb-8 border-primary/20 rounded-2xl bg-gradient-to-br from-primary/5 to-card">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button onClick={() => window.location.reload()} className="gap-2 rounded-xl min-h-[44px] shadow-sm">
