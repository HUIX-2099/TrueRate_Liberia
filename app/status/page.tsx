      ...
      <main className="py-10 sm:py-14 md:py-24 flex-1 bg-background pb-20 md:pb-0 overflow-x-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            {error && !data && (
              <Card className="rounded-2xl border-destructive/50">
                <CardContent className="py-6">
                  ...
                  <Button onClick={fetchHealth} className="gap-2 rounded-xl min-h-[44px]">
            ...
            {data && (
              <>
                <Card className={`rounded-2xl border-border/40 ${ overall === "ok" ? "border-green-500/30 bg-green-50/30 dark:bg-green-950/20" : overall === "degraded" ? "border-amber-500/30 bg-amber-50/30 dark:bg-amber-950/20" : "border-destructive/30 bg-destructive/5" }`}>
                ...
                <Card className={`rounded-2xl border-border/40 ${ mocOverall === "ok" ? "border-green-500/30 bg-green-50/30 dark:bg-green-950/20" : mocOverall === "degraded" ? "border-amber-500/30 bg-amber-50/30 dark:bg-amber-950/20" : "border-destructive/30 bg-destructive/5" }`}>
                  <CardHeader className="flex flex-row items-center justify-between">
                    <CardTitle className="text-base flex items-center gap-2">
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  <Button variant="outline" asChild size="sm" className="rounded-xl min-h-[44px]">
                    <a href="/admin/monitoring">Monitoring dashboard</a>
                  </Button>
                </div>

                <div className="flex justify-center">
                  <Button variant="outline" onClick={fetchHealth} disabled={loading} className="gap-2 rounded-xl min-h-[44px]">
