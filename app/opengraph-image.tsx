...
export const alt = 'TrueRate Liberia - trusted rates and everyday money tools'
export const size = {
  width: 1200,
  height: 630,
}
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Trusted USD/LRD updates for Liberia
          </div>
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <span style={{ fontSize: '20px', color: '#d4d4d8', display: 'flex' }}>Rate Outlook</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
