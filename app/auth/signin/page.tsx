          ...
          <div className="grid gap-10 md:grid-cols-2 items-center max-w-5xl mx-auto">
            ...
            <div className="space-y-6 text-center md:text-left order-2 md:order-1">
              ...
              <p className="text-base sm:text-lg text-muted-foreground text-pretty max-w-md md:max-w-none">
                Track verified rates, compare changers nearby, and get practical insights in one dashboard.
              </p>
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="flex items-center gap-3 rounded-xl border border-border/60 bg-card/80 px-4 py-3.5 text-sm shadow-sm">
            ...
            {/* Right: form card */}
            <Card className="border-border/80 shadow-xl shadow-primary/5 bg-card/95 backdrop-blur-sm rounded-2xl order-1 md:order-2">
